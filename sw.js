const CACHE = 'pekahellix-v0.5-h.2.5.2';
const APP_SHELL = [
  './', './index.html', './style.css?v=0.5-h.2.4', './script.js?v=0.5-h.2.4', './config.js', './logo.png', './logo-header.png', './logo-auth.png', './favicon.png',
